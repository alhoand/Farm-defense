...
std::vector<EnemyData> initializeEnemyData()
{
	...
	data[Enemy::Fire].path.push_back(Direction(+90.f, 400.f));
	data[Enemy::Fire].path.push_back(Direction(0.f, 400.f));
    data[Enemy::Fire].path.push_back(Direction(-90.f, 400.f));
	...
	data[Enemy::Leaf].path.push_back(Direction(+90.f, 400.f));
	data[Enemy::Leaf].path.push_back(Direction(0.f, 400.f));
    data[Enemy::Leaf].path.push_back(Direction(-90.f, 400.f));
...
void Enemy::updateMovementPattern(sf::Time dt)
{
	...
	if (!path.empty())
	{
		...
		float radians = (3.141592653589793238462643383f / 180.f) * (path[directionIndex_].angle); // helper function toRadian?
