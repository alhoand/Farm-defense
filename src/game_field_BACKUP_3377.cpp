...
<<<<<<< HEAD
	std::unique_ptr<Tower> firstTower(new Tower(Tower::Type::Fire, textures_, 250.f, 3, Bullet::Type::FireBullet, commandQueue_));
=======
	std::unique_ptr<Tower> firstTower(new Tower(Tower::Type::Fire, textures_));
>>>>>>> 4af7ec964e5ed8aa7d2fff40f31c6543e04d07d4
