...
, GUIContainer_(context)
{
	...
	auto playButton = std::make_shared<GUI::Button>(*context.fonts_, *context.textures_,Textures::ID::PlankNormal,Textures::ID::PlankSelected);
...
/*
	...
	auto exitButton = std::make_shared<GUI::Button>(*context.fonts_, *context.textures_,Textures::ID::PlankNormal2,Textures::ID::PlankSelected2);
